...
const hardwareBackButton = require('./hardware-back-button-9931602c.js');
...
const index$3 = require('./index-8a653282.js');
    ...
    componentDidLoad() {
        {
            rIC(async () => {
                ...
                if (ionicGlobal.config.getBoolean('statusTap', isHybrid)) {
                    Promise.resolve().then(function () { return require('./status-tap-607c6244.js'); }).then((module) => module.startStatusTap());
                }
                ...
                const hardwareBackButtonModule = await Promise.resolve().then(function () { return require('./hardware-back-button-9931602c.js'); });
